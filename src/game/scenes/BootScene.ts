...
import playerImg from '../../../assets/player-new.webp';
...
import bush1Img from '../../../assets/decorations/bush-1.webp';
import bush2Img from '../../../assets/decorations/bush-2.webp';
import bush3Img from '../../../assets/decorations/bush-3.webp';
import tree1Img from '../../../assets/decorations/tree-1.webp';
import tree2Img from '../../../assets/decorations/tree-2.webp';
import lampImg from '../../../assets/decorations/street-lamp.webp';
...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image('bush-2', bush2Img);
    this.load.image('bush-3', bush3Img);
    this.load.image('tree-1', tree1Img);
    this.load.image('tree-2', tree2Img);
    this.load.image('street-lamp', lampImg);
